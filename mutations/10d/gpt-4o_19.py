...
def mutate_operation(self, idv, spk_pop, spk_fit):
    ...
    # Differential vector between best centroid and individual
    diff_vector = best_centroid - idv
    
    # Gaussian noise and Levy flight
    ...
    # Combine differential vector, Gaussian noise, and Levy flight
