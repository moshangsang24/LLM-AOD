...
def mutate_operation(self, idv, spk_pop, spk_fit):
    ...
    # Combination of Gaussian, Uniform, Levy flight, Differential Evolution (DE) perturbations, and Simulated Annealing (SA)
    ...
    combined_perturbation = 0.25 * gaussian_perturbation + 0.25 * uniform_perturbation + 0.2 * levy_perturbation + 0.15 * de_perturbation + 0.15 * sa_perturbation
